...
Declare @JSON varchar(max)
SELECT @JSON=BulkColumn
FROM OPENROWSET (BULK 'E:\temp\data_1250000_2.json', SINGLE_CLOB) as import
...
Declare @JSON varchar(max)
SELECT @JSON=BulkColumn
FROM OPENROWSET (BULK 'E:\temp\data_1250000_3.json', SINGLE_CLOB) as import
...
Declare @JSON varchar(max)
SELECT @JSON=BulkColumn
FROM OPENROWSET (BULK 'E:\temp\data_1250000_4.json', SINGLE_CLOB) as import
